    ...
    while True:
        if GPIO.input (BT1) == GPIO.LOW:
            ...
            while True:
                ...
                # Hợp xanh và đỏ lại
                # Nhóm mask xanh và đỏ lại bằng phép cộng ma trận
                group = green_mask + red_mask
                # Các phần tử trong ma trận (Lớn >= 1 là True và ngược lại)
                group = group >= 1 # Tù kiểu bool chuyển sang kiểu uint8, nhân với 255 để maskgroup có màu trắng
                # Tù kiểu bool chuyển sang kiểu uint8, nhân với 255 để maskgroup có màu trắng
